...
export const FormCheckbox = ({
  ...
  return (
    <div
      className={`inline-flex items-center gap-3 relative top-[801px] left-[1100px] ${className}`}
    >
      <div className="relative w-[18px] h-[18px] bg-grey-light rounded border-2 border-solid border-[#a4a4a4]" />
