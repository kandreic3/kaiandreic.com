...
const BurkeMuseumPage = () => {
  ...
  return (
    ...
    >
      ...
      >
        <img
          src="https://res.cloudinary.com/dkdwqtlzz/image/upload/f_auto,q_auto,w_2000,c_limit/Burke_Museum_pzgb10.png"
      ...
      <div className="px-6 max-w-[1100px] mx-auto mb-20">
        ...
        <div className="mb-6">
          ...
          loading="lazy"
          decoding="async"
                  src="https://res.cloudinary.com/dkdwqtlzz/image/upload/f_auto,q_auto,w_1800,c_limit/Burke_Pages_ive2r8.webp"
        ...
        <div>
          ...
          loading="lazy"
          decoding="async"
                      src="https://res.cloudinary.com/dkdwqtlzz/image/upload/f_auto,q_auto,w_500,c_limit/Mobile_-_Home_Page_guhadm.png"
          ...
          loading="lazy"
          decoding="async"
                      src="https://res.cloudinary.com/dkdwqtlzz/image/upload/f_auto,q_auto,w_500,c_limit/Mobile_-_Arts_Culture_Page_sa4dra.png"
