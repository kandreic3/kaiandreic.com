...
const RecognizeAppPage = () => {
  ...
  return (
    ...
    >
      ...
      >
        <img
          src="https://res.cloudinary.com/dkdwqtlzz/image/upload/f_auto,q_auto:best,dpr_3.0,w_3800,c_limit,e_sharpen:120/v1777049980/Recognize_w98sxb.png"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              ...
              <div className="flex items-center gap-3 pt-4 border-t border-black/8 mt-auto">
                <img
                  src="https://res.cloudinary.com/dkdwqtlzz/image/upload/v1777942326/image-10de4f4b-1437-44b5-b59e-26482d4dcf3a_yuiw67.webp"
                  alt="Zach Grande"
