  ...
  return (
    <div className="relative box-border caret-transparent overflow-hidden my-28 px-5">
      <div className="relative text-[47.5px] box-border caret-transparent flex flex-wrap justify-between tracking-[-2.375px] leading-[47.5px] z-[1] py-12 md:text-[65.6px] md:tracking-[-3.28px] md:leading-[65.6px]">
        <div
          className="text-[47.5px] box-border caret-transparent tracking-[-2.375px] leading-[47.5px] min-h-[auto] min-w-[auto] mr-2 md:text-[65.6px] md:tracking-[-3.28px] md:leading-[65.6px]"
          style={{
            fontWeight: 400,
        ...
        <div
          className="text-[47.5px] box-border caret-transparent tracking-[-2.375px] leading-[47.5px] min-h-[auto] min-w-[auto] md:text-[65.6px] md:tracking-[-3.28px] md:leading-[65.6px]"
          style={{
            fontWeight: 400,
            fontFamily: "'PP Editorial Old', 'PPEditorialOld', Georgia, serif",
          }}
