...
<todo id="hero-bio">
Update hero tagline & heading
The current heading still references interior design — update it to reflect Kai's UX work and personal voice.
</todo>

<todo id="project-cards">
Replace project cards with Kai's real UX work
Swap out the interior design project images/links with actual UX case studies or portfolio pieces.
</todo>

<todo id="showroom-to-process">
Repurpose the Showroom section
The showroom grid could become a "Process", "Skills", or "Tools" showcase relevant to UX design.
</todo>

<todo id="custom-video">
Add a personal hero video or image
The current hero video is from Farah's site — replace it with something representing Kai's work or aesthetic.
</todo>
